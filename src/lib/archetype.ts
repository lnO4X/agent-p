...
export const ARCHETYPES: Record<string, Archetype> = {
  "lightning-assassin": {
    ...
    evolutionId: "duelist",
    evolutionHint: "提升反应抑制到B级，你将进化为冷血决斗者——速度与智慧兼具。",
    evolutionHintEn: "Raise Response Inhibition to B rank to evolve into the Duelist — speed meets intellect.",
  ...
  berserker: {
    ...
    description:
      "你是战场上最不可预测的存在。高速反应加上冒险本能，你的打法没有章法，但偏偏有效。你在大逃杀里落地就冲，在FPS里永远在突脸，在格斗游戏里疯狂按键居然能赢。你的干扰抑制是最大弱点——连败时你会越打越急，直到彻底崩盘。",
    descriptionEn:
    ...
    evolutionHint: "提升干扰抑制到B级，你将进化为闪电刺客——保留速度，去掉失控。",
    evolutionHintEn: "Raise Interference Suppression to B rank to evolve into Lightning Assassin — keep the speed, lose the chaos.",
  ...
  duelist: {
    ...
    weakness: "你是完美的独行者，但在需要视角转换的场景里，你不知道如何理解队友的意图。",
    ...
    evolutionHint: "这已经是操作型的终极形态。提升视角转换，你将解锁独狼——不是不能合作，而是选择何时独行。",
    evolutionHintEn: "This is peak reflexive form. Raise Perspective Taking to unlock Lone Wolf — choosing when to go solo, not being forced to.",
  ...
  fortress: {
    ...
    description:
      "你是耐心的化身。超强的视觉注意广度配合冷静的干扰抑制，你在任何消耗战中都立于不败之地。模拟经营游戏里你的收益曲线完美，策略游戏里你龟缩发育让对手绝望，塔防游戏里你的防线密不透风。你的弱点是进攻——你太稳了，稳到错失了无数主动出击的机会。",
    descriptionEn:
  ...
  "shadow-strategist": {
    ...
    strongTalent: "strategy_logic",
    evolutionId: "oracle",
    evolutionHint: "提升视角转换到B级，你将进化为预言师——用更开放的视角看到更大的棋局。",
    evolutionHintEn: "Raise Perspective Taking to B rank to evolve into Oracle — see the bigger picture with an open mind.",
  ...
  gambler: {
    ...
    evolutionId: "shadow-strategist",
    evolutionHint: "提升干扰抑制到B级，你将进化为暗影策士——保留冒险直觉，加上冷静执行。",
    evolutionHintEn: "Raise Interference Suppression to B rank to evolve into Shadow Strategist — keep the instincts, add cold execution.",
  ...
  weaver: {
    ...
    evolutionHint: "提升干扰抑制到B级，你将进化为指挥官——多线程+冷静=最强大脑。",
    evolutionHintEn: "Raise Interference Suppression to B rank to evolve into Commander — multithreading + composure = ultimate brain.",
  ...
  sentinel: {
    ...
    description:
      "你是团队的基石。超强的空间感知让你总能找到最佳防守位置，稳定的干扰抑制让你在逆境中屹立不倒，出色的视觉注意广度让你永远不会错过任何动静。塔防游戏里你的防线无懈可击，FPS里你是最可靠的anchor选手，生存游戏里你的据点固若金汤。你的弱点是主动进攻——你习惯了反应，不擅长主动创造机会。",
    descriptionEn:
  ...
  collector: {
    ...
    description:
      "你的大脑是一个精密的数据库。超强的记忆力配合敏锐的模式识别和宽广的视觉注意广度，你注意到别人忽略的每一个细节。RPG里你收集每一个成就，策略游戏里你的资源利用率接近100%，解谜游戏里你能记住每一条线索。你的弱点是速度——你太追求完美了，以至于在需要快速决策时犹豫不决。",
    descriptionEn:
  ...
  "chaos-child": {
    ...
    strongTalent: "risk_assessment",
    evolutionId: "gambler",
    evolutionHint: "提升干扰抑制到B级，你将进化为混沌赌徒——保留混沌，学会收手。",
    evolutionHintEn: "Raise Interference Suppression to B rank to evolve into Gambler — keep the chaos, learn when to stop.",
